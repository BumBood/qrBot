...
async def cmd_start(message: Message, session: AsyncSession):
    ...
    message_text = (
        "<b>Ваша скидка на средства «Айсида»:</b>\n\n"
        "<b>На сайте «Планета Здоровья»:</b>\n"
        "⭐ 200 ₽ при покупке 1 средства — промо-код <b>АЙСИДА200</b>\n"
        "⭐ 500 ₽ при покупке 2-х одинаковых средств — промо-код <b>АЙСИДА500</b>\n"
        '🔗 <a href="https://planetazdorovo.ru/search/?sort=sort&q=%D0%90%D0%B9%D1%81%D0%B8%D0%B4%D0%B0&appointments=&is_favorite_store=&product_price_min=148&product_price_max=1089&brand%5B%5D=1322&set_filter=Y">Перейти в «Планету Здоровья»</a>\n\n'
        "<b>На OZON</b>\n"
        "• При заказе любых двух средств «Айсида» скидка ⭐ 500 ₽ применяется автоматически в корзине\n"
        '🔗 <a href="https://www.ozon.ru/seller/krasota-i-zdorove-2476599/products/?miniapp=seller_2476599&text=%D0%B0%D0%B9%D1%81%D0%B8%D0%B4%D0%B0">Перейти в OZON</a>\n\n'
        "💚 Получите бережный уход за кожей по специальной цене и участвуйте в еженедельном розыгрыше сертификата <b>OZON на 5 000 ₽</b>!\n\n"
        "<b>🎁 Как участвовать в розыгрыше:</b>\n"
        "1️⃣ После покупки в меню бота нажмите «Зарегистрировать покупку»\n"
        "2️⃣ Загрузите фото чека (бумажного или электронного) или введите данные вручную\n"
        "3️⃣ Ждите понедельника — розыгрыш проходит каждую неделю!\n\n"
        "Готовы участвовать? Нажмите «Зарегистрировать покупку» или откройте «Меню» для подробностей.\n"
        "👇👇👇"
    )
    photo = FSInputFile("data/pics/start.png")
...
async def callback_main_menu(callback: CallbackQuery):
    ...
    """
    text = "Главное меню:"
    # Поддерживаем как текстовые, так и фото-сообщения
...
async def callback_about_aisida(callback: CallbackQuery):
    ...
    """
    about_text = """1. <b>Пенка для умывания «Айсида»</b>
Мягко очищает сухую и чувствительную кожу, не нарушая её естественный гидробаланс. Обеспечивает длительное увлажнение и восстанавливает барьерные свойства за счёт комплекса натуральных экстрактов и АСД. Идеальна для ежедневного ухода и подготовки кожи к дальнейшим этапам ухода.
 🔗 Купить пенку на сайте «Планета здоровья»:  https://planetazdorovo.ru/moskva/catalog/kosmetika/ukhod-za-litsom/ochishchenie-tonizatsiya/ajsida-penka-dlya-umyvaniya-160m-23255811/

2. <b>Крем для сухой и чувствительной кожи лица и тела «Айсида» (50 мл) или (250 мл)</b>
Интенсивно питает и увлажняет, устраняет покраснения и раздражение благодаря 98 % натуральным ингредиентам с маслами липы, лаванды и АСД. Восстанавливает гидролипидный баланс и возвращает ощущение комфорта даже после агрессивных процедур. Подходит для ежедневного применения утром и вечером.
 🔗 Купить крем 50 мл на сайте «Планета здоровья»: https://planetazdorovo.ru/moskva/catalog/kosmetika/ukhod-za-telom/spetsialnyy-ukhod/krem-dlya-lica-i-tela-dlya-suhoj-3374311/
🔗 Купить крем 250 мл на сайте «Планета здоровья»: https://planetazdorovo.ru/moskva/catalog/kosmetika/ukhod-za-telom/spetsialnyy-ukhod/krem-dlya-lica-i-tela-dlya-suhoj-8912111/

3. <b>Крем для жирной и комбинированной кожи лица и тела «Айсида» (50 мл)</b>
Нормализует гидролипидный баланс и препятствует появлению несовершенств благодаря АСД, маслу сладкого миндаля и экстрактам овса и василька. Оказывает противовоспалительное действие, ускоряет заживление без рубцов и помогает контролировать работу сальных желёз. Формула на 97 % натуральна, не содержит гормонов, парабенов, синтетических красителей и силиконов.
 🔗 Купить крем на сайте «Планета здоровья»:  https://planetazdorovo.ru/moskva/catalog/kosmetika/ukhod-za-telom/spetsialnyy-ukhod/krem-dlya-lica-i-tela-dlya-zhirno-4139511/

4. <b>Шампунь «Айсида» с АСД для всех типов волос (250 мл)</b>
Эффективно устраняет зуд и шелушение, укрепляет корни и защищает от перхоти без парабенов и отдушек. Липосомальная форма АСД глубоко проникает в кожу головы, восстанавливая её естественный баланс. Рекомендуется для людей, страдающих себореей, выпадением волос и возрастными изменениями.
 🔗 Купить шампунь на сайте «Планета здоровья»:  https://planetazdorovo.ru/moskva/catalog/kosmetika/ukhod-za-volosami/shampuni/shampun-dlya-vseh-tipov-volos-s-10729811/


5. <b>Бальзам-маска для сухой кожи головы «Айсида» (250 мл)</b>
Идеальный компаньон к шампуню «Айсида» при себорейном дерматите, псориазе кожи головы, а также при обычной сухости и шелушении. В составе 98 % натуральных ингредиентов, включая масла репейника и оливы, АСД и эфирные масла лаванды и лимонника, что позволяет одновременно успокаивать раздражённую кожу, глубоко её питать и препятствовать образованию перхоти. При сочетании с противогрибковыми шампунями (кетоконазол) бальзам-маска усиливает их терапевтический эффект и помогает ускорить восстановление.
 🔗 Купить бальзам-маску на сайте «Планета здоровья»:  https://planetazdorovo.ru/moskva/catalog/kosmetika/ukhod-za-volosami/balzamy-konditsionery/balzam-dlya-volos-dlya-suhoj-ko-4493411/

6. <b>Крем для ног «Айсида» с АСД и мочевиной 30 % (50 мл)</b>
Специальная формула интенсивно увлажняет и смягчает грубую и утолщённую кожу стоп, деликатно отшелушивая натоптыши и мозоли. Способствует заживлению микротравм и восстановлению гидролипидного слоя благодаря сочетанию мочевины и АСД Айсида крем для ног. Лёгкая текстура быстро впитывается и не оставляет следов.
 🔗 Купить крем на сайте «Планета здоровья»:  https://planetazdorovo.ru/moskva/catalog/kosmetika/ukhod-za-nogami/sredstva-dlya-ukhoda/ajsida-krem-dlya-nog-50ml-s-asd-17297211/
...
async def callback_faq(callback: CallbackQuery):
    ...
    faq_text = (
        ...
        "8. <b>Где найти чек из OZON?</b>\n"
        "Перейдите в раздел «Мои заказы», выберите нужный заказ и найдите в нем раздел «Чеки по заказу». "
        "Скачайте или сделайте скриншот чека в разделе «Получение товаров» — «Чек о реализации»."
    )
    builder = InlineKeyboardBuilder()
    builder.button(text="Меню", callback_data="main_menu")
